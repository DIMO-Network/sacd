...
// CurrentPaymentRecord is a free data retrieval call binding the contract method 0x0f7d31f6.
//
...
func (_Sacd *SacdCaller) CurrentPaymentRecord(opts *bind.CallOpts, asset common.Address, grantee common.Address, grantor common.Address) (ISacdPaymentRecord, error) {
	var out []interface{}
	err := _Sacd.contract.Call(opts, &out, "currentPaymentRecord", asset, grantee, grantor)
...
//
// Solidity: function currentPaymentRecord(address asset, address grantee, address grantor) view returns((uint256,uint64,bytes3,string) paymentRecord)
func (_Sacd *SacdSession) CurrentPaymentRecord(asset common.Address, grantee common.Address, grantor common.Address) (ISacdPaymentRecord, error) {
	return _Sacd.Contract.CurrentPaymentRecord(&_Sacd.CallOpts, asset, grantee, grantor)
}

// CurrentPaymentRecord is a free data retrieval call binding the contract method 0x0f7d31f6.
//
// Solidity: function currentPaymentRecord(address asset, address grantee, address grantor) view returns((uint256,uint64,bytes3,string) paymentRecord)
func (_Sacd *SacdCallerSession) CurrentPaymentRecord(asset common.Address, grantee common.Address, grantor common.Address) (ISacdPaymentRecord, error) {
	return _Sacd.Contract.CurrentPaymentRecord(&_Sacd.CallOpts, asset, grantee, grantor)
}
...
// NextPaymentId is a free data retrieval call binding the contract method 0x8f4390ac.
//
// Solidity: function nextPaymentId(address asset, address grantee, address grantor) view returns(uint256 paymentId)
func (_Sacd *SacdCaller) NextPaymentId(opts *bind.CallOpts, asset common.Address, grantee common.Address, grantor common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Sacd.contract.Call(opts, &out, "nextPaymentId", asset, grantee, grantor)
...
//
// Solidity: function nextPaymentId(address asset, address grantee, address grantor) view returns(uint256 paymentId)
func (_Sacd *SacdSession) NextPaymentId(asset common.Address, grantee common.Address, grantor common.Address) (*big.Int, error) {
	return _Sacd.Contract.NextPaymentId(&_Sacd.CallOpts, asset, grantee, grantor)
}

// NextPaymentId is a free data retrieval call binding the contract method 0x8f4390ac.
//
// Solidity: function nextPaymentId(address asset, address grantee, address grantor) view returns(uint256 paymentId)
func (_Sacd *SacdCallerSession) NextPaymentId(asset common.Address, grantee common.Address, grantor common.Address) (*big.Int, error) {
	return _Sacd.Contract.NextPaymentId(&_Sacd.CallOpts, asset, grantee, grantor)
}

// PaymentRecords is a free data retrieval call binding the contract method 0x51f88a65.
//
...
func (_Sacd *SacdCaller) PaymentRecords(opts *bind.CallOpts, asset common.Address, grantee common.Address, grantor common.Address, paymentId *big.Int) (ISacdPaymentRecord, error) {
	var out []interface{}
	err := _Sacd.contract.Call(opts, &out, "paymentRecords", asset, grantee, grantor, paymentId)
...
//
// Solidity: function paymentRecords(address asset, address grantee, address grantor, uint256 paymentId) view returns((uint256,uint64,bytes3,string) paymentRecord)
func (_Sacd *SacdSession) PaymentRecords(asset common.Address, grantee common.Address, grantor common.Address, paymentId *big.Int) (ISacdPaymentRecord, error) {
	return _Sacd.Contract.PaymentRecords(&_Sacd.CallOpts, asset, grantee, grantor, paymentId)
}

// PaymentRecords is a free data retrieval call binding the contract method 0x51f88a65.
//
// Solidity: function paymentRecords(address asset, address grantee, address grantor, uint256 paymentId) view returns((uint256,uint64,bytes3,string) paymentRecord)
func (_Sacd *SacdCallerSession) PaymentRecords(asset common.Address, grantee common.Address, grantor common.Address, paymentId *big.Int) (ISacdPaymentRecord, error) {
	return _Sacd.Contract.PaymentRecords(&_Sacd.CallOpts, asset, grantee, grantor, paymentId)
}
...
// SetPayment is a paid mutator transaction binding the contract method 0xa23cac39.
//
...
func (_Sacd *SacdTransactor) SetPayment(opts *bind.TransactOpts, asset common.Address, grantor common.Address, amount *big.Int, expiration uint64, currency [3]byte, source string) (*types.Transaction, error) {
	return _Sacd.contract.Transact(opts, "setPayment", asset, grantor, amount, expiration, currency, source)
}

// SetPayment is a paid mutator transaction binding the contract method 0xa23cac39.
//
// Solidity: function setPayment(address asset, address grantor, uint256 amount, uint64 expiration, bytes3 currency, string source) returns()
func (_Sacd *SacdSession) SetPayment(asset common.Address, grantor common.Address, amount *big.Int, expiration uint64, currency [3]byte, source string) (*types.Transaction, error) {
	return _Sacd.Contract.SetPayment(&_Sacd.TransactOpts, asset, grantor, amount, expiration, currency, source)
}

// SetPayment is a paid mutator transaction binding the contract method 0xa23cac39.
//
// Solidity: function setPayment(address asset, address grantor, uint256 amount, uint64 expiration, bytes3 currency, string source) returns()
func (_Sacd *SacdTransactorSession) SetPayment(asset common.Address, grantor common.Address, amount *big.Int, expiration uint64, currency [3]byte, source string) (*types.Transaction, error) {
	return _Sacd.Contract.SetPayment(&_Sacd.TransactOpts, asset, grantor, amount, expiration, currency, source)
}
...
// SacdPaymentSetIterator is returned from FilterPaymentSet and is used to iterate over the raw logs and unpacked data for PaymentSet events raised by the Sacd contract.
type SacdPaymentSetIterator struct {
	Event *SacdPaymentSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SacdPaymentSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SacdPaymentSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SacdPaymentSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
// FilterPaymentSet is a free log retrieval operation binding the contract event 0xea8d632c616b0a57034db544e22aee1a35cb4092ddc8215008b13bf791b2bfa5.
//
...
func (_Sacd *SacdFilterer) FilterPaymentSet(opts *bind.FilterOpts, asset []common.Address, grantee []common.Address, grantor []common.Address) (*SacdPaymentSetIterator, error) {
	...
	logs, sub, err := _Sacd.contract.FilterLogs(opts, "PaymentSet", assetRule, granteeRule, grantorRule)
	if err != nil {
		return nil, err
	}
	return &SacdPaymentSetIterator{contract: _Sacd.contract, event: "PaymentSet", logs: logs, sub: sub}, nil
}

// WatchPaymentSet is a free log subscription operation binding the contract event 0xea8d632c616b0a57034db544e22aee1a35cb4092ddc8215008b13bf791b2bfa5.
//
// Solidity: event PaymentSet(address indexed asset, address indexed grantee, address indexed grantor, uint256 amount, uint256 expiration, string source)
func (_Sacd *SacdFilterer) WatchPaymentSet(opts *bind.WatchOpts, sink chan<- *SacdPaymentSet, asset []common.Address, grantee []common.Address, grantor []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Sacd.contract.WatchLogs(opts, "PaymentSet", assetRule, granteeRule, grantorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SacdPaymentSet)
				if err := _Sacd.contract.UnpackLog(event, "PaymentSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParsePaymentSet is a log parse operation binding the contract event 0xea8d632c616b0a57034db544e22aee1a35cb4092ddc8215008b13bf791b2bfa5.
//
// Solidity: event PaymentSet(address indexed asset, address indexed grantee, address indexed grantor, uint256 amount, uint256 expiration, string source)
func (_Sacd *SacdFilterer) ParsePaymentSet(log types.Log) (*SacdPaymentSet, error) {
	event := new(SacdPaymentSet)
	if err := _Sacd.contract.UnpackLog(event, "PaymentSet", log); err != nil {
		return nil, err
	}
