...
func (sacd *Sacd) PackAccountPermissionRecords(grantor common.Address, grantee common.Address) []byte {
	enc, err := sacd.abi.Pack("accountPermissionRecords", grantor, grantee)
	if err != nil {
		panic(err)
	}
	return enc
...
// from invoking the contract method with ID 0x30eaba75.
//
// Solidity: function accountPermissionRecords(address grantor, address grantee) view returns((uint256,uint256,string,uint256) permissionRecord)
func (sacd *Sacd) UnpackAccountPermissionRecords(data []byte) (ISacdPermissionRecord, error) {
	out, err := sacd.abi.Unpack("accountPermissionRecords", data)
	if err != nil {
...
func (sacd *Sacd) PackGetAccountPermissions(grantor common.Address, grantee common.Address, permissions *big.Int) []byte {
	enc, err := sacd.abi.Pack("getAccountPermissions", grantor, grantee, permissions)
	if err != nil {
		panic(err)
	}
	return enc
...
// from invoking the contract method with ID 0x6805e547.
//
// Solidity: function getAccountPermissions(address grantor, address grantee, uint256 permissions) view returns(uint256)
func (sacd *Sacd) UnpackGetAccountPermissions(data []byte) (*big.Int, error) {
	out, err := sacd.abi.Unpack("getAccountPermissions", data)
	if err != nil {
...
func (sacd *Sacd) PackHasAccountPermission(grantor common.Address, grantee common.Address, permissionIndex uint8) []byte {
	enc, err := sacd.abi.Pack("hasAccountPermission", grantor, grantee, permissionIndex)
	if err != nil {
		panic(err)
	}
	return enc
...
// from invoking the contract method with ID 0x4fbaaafd.
//
// Solidity: function hasAccountPermission(address grantor, address grantee, uint8 permissionIndex) view returns(bool)
func (sacd *Sacd) UnpackHasAccountPermission(data []byte) (bool, error) {
	out, err := sacd.abi.Unpack("hasAccountPermission", data)
	if err != nil {
		return *new(bool), err
	}
...
func (sacd *Sacd) PackHasAccountPermissions(grantor common.Address, grantee common.Address, permissions *big.Int) []byte {
	enc, err := sacd.abi.Pack("hasAccountPermissions", grantor, grantee, permissions)
	if err != nil {
		panic(err)
	}
	return enc
...
// from invoking the contract method with ID 0x64e2cd2c.
//
// Solidity: function hasAccountPermissions(address grantor, address grantee, uint256 permissions) view returns(bool)
func (sacd *Sacd) UnpackHasAccountPermissions(data []byte) (bool, error) {
	out, err := sacd.abi.Unpack("hasAccountPermissions", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (sacd *Sacd) PackSetAccountPermissions(grantee common.Address, permissions *big.Int, expiration *big.Int, templateId *big.Int, source string) []byte {
	enc, err := sacd.abi.Pack("setAccountPermissions", grantee, permissions, expiration, templateId, source)
	if err != nil {
		panic(err)
	}
	return enc
